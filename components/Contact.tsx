          ...
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-forest-50 to-gold-50/50 border border-forest-100">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 mb-8">
              ...
              >
                ...
                <div>
                  <span className="font-display font-semibold text-navy-700 text-sm group-hover:text-red-600 transition-colors">YouTube</span>
                  <p className="text-navy-400 text-xs">문형철 치유연구소</p>
                </div>
              </a>
